...
public class LagnaPredictionPage extends BasePage {
	/*
	...
	public LagnaPredictionPage(DesktopHoroNew desktopHoro, BirthDetailBean birthDetailBean) {
		...
		arrayList.add(new ParagraphDetail("vkidk yXu gS% " + lagna, constantHindi.lagnaDesc));
	...
	public PageInfo drawPage(PDDocument document, PDType0Font poppinsRegularFont, PDType0Font krutiDevRegularFont) {
		String pageHeading = "yXu fjiksVZ";
		...
		try {
			...
			drawCornerImages();
			drawHeader(pageWidth, pageHeight, krutiDevRegularFont, "yXu fjiksVZ");
