...
public class NakshReportPage extends BasePage {
	/*
	 * Color[][] headerGradientColors = { { new Color(255, 224, 145), new Color(255,
	 * 197, 75) }, { new Color(190, 213, 255), new Color(135, 174, 245) }, { new
	 * Color(195, 242, 207), new Color(145, 220, 170) }, { new Color(255, 205, 220),
	 * new Color(255, 160, 190) }, { new Color(255, 205, 235), new Color(245, 160,
	 * 210) }, { new Color(255, 225, 150), new Color(255, 195, 75) }, { new
	 * Color(190, 225, 255), new Color(130, 195, 250) }, { new Color(255, 205, 210),
	 * new Color(255, 155, 170) }, { new Color(190, 240, 238), new Color(125, 210,
	 * 210) }, { new Color(255, 225, 150), new Color(255, 195, 75) }, { new
	 * Color(190, 225, 255), new Color(130, 195, 250) }, { new Color(255, 205, 210),
	 * new Color(255, 155, 170) }, { new Color(190, 240, 238), new Color(125, 210,
	 * 210) } };
	...
	public NakshReportPage(DesktopHoroNew desktopHoro, BirthDetailBean birthDetailBean) {
		...
		arrayList.add(new ParagraphDetail("vkidk u{k= gS% " + nakshtra, constantHindi.lagnaDesc));
	...
	private float createNewPage(PDDocument document, PDType0Font poppinsRegularFont, PDType0Font krutiDevRegularFont)
		...
		drawCornerImages();
		drawHeader(pageWidth, pageHeight, krutiDevRegularFont, "u{k= fjiksVZ");
		drawFooter(poppinsRegularFont, poppinsRegularFont, 15);
	...
	private float printParagraphOld(float startX, float startY, String heading, List<String> lines, int colorIndex)
			throws Exception {

		final float headingHeight = 25f;
		...
		drawColorShape.drawGradientHeader(startX, headerY, availableWidth, headingHeight, cornerRadius,
				headerGradientColors[colorIndex][1], headerGradientColors[colorIndex][0],
				headerGradientColors[colorIndex][1], headerGradientColors[colorIndex][1]);

		float headingY = headerY + 7f;
		...
		for (String line : lines) {
			...
			drawColorShape.drawText(startX + 15f, yPosition, line, krutiDevRegularFont, fontSize, Color.BLACK);
			yPosition -= leading;
		}
		yPosition += leading;
		...
		if (bodyHeight > 0) {
			...
			drawColorShape.drawRoundedBottomRectangle(startX, bottomY, availableWidth, bodyHeight, cornerRadius);
			contentStream.stroke();
			float lineX = startX + 6f;
			float lineTop = bodyTop - verticalPadding;
			float lineBottom = bottomY + verticalPadding;
			contentStream.setLineWidth(verticalLineWidth);
			contentStream.setLineCapStyle(1);
			contentStream.moveTo(lineX, lineTop);
			contentStream.lineTo(lineX, lineBottom);
			contentStream.stroke();
